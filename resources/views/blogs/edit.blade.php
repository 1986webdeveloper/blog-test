...
@section('content')
    <div class="row mb-4">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left text-center">
                <h2 class="text-3xl">Edit Blog</h2>
            </div>
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mb-4">
                <div class="form-group">
                    <strong>Title:</strong>
                    <input type="text" name="title" id="title" value="{{ $blog->title }}" class="form-control bg-white" placeholder="Title">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 mb-4">
                <div class="form-group">
                    <strong>Body:</strong>
                    <textarea class="form-control h-40" name="body" id="body" placeholder="Body">{{ $blog->body }}</textarea>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
              <button type="submit" class="btn btn-primary bg-[#0d6efd] text-white">Submit</button>
            </div>
        </div>
    </form>
    ...
    <script>
        var blogUrl = "{{ route('blogs.update',$blog->id) }}";
